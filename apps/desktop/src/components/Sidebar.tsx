...
const NAV_ITEMS = [
  ...
  { id: "bible" as const, label: "Bíblia", icon: (
        ...
        {NAV_ITEMS.map((item, i) => {
          ...
          return (
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-150 hover:bg-[#1a1a28]"
              style={{
